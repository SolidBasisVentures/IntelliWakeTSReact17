...
const FieldSetRow = (props) => {
    ...
    const settings = React.useMemo(() => {
        ...
        if (!!props.label) {
            items.labelColProps = {};
            items.labelColProps.className = `strong ${(_a = props.labelClassName) !== null && _a !== void 0 ? _a : ''}`.trim();
            if (breakAt === 'xs') {
            ...
            React__default["default"].createElement("div", { className: ('modal-dialog' +
                ...
                React__default["default"].createElement("div", { className: 'modal-content', onMouseDown: e => e.stopPropagation(), onClick: e => e.stopPropagation(), style: props.contentStyle, ref: contentRef }, props.title !== undefined ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                    ...
                    React__default["default"].createElement("div", { className: `modal-body${!!props.overFlowVisible ? ' no-overflow-scroll overflow-visible container container-fluid fill-height' : !!props.noOverFlowScroll ? ' no-overflow-scroll overflow-hidden container container-fluid fill-height' : ' m-4 p-0'} ${(_c = props.bodyClassName) !== null && _c !== void 0 ? _c : ''}`.trim(), style: props.bodyStyle }, !!props.bodyContainerFormSubmit ? (React__default["default"].createElement(Form, { className: `container ${typeof props.bodyContainerFormSubmit === 'string' ? props.bodyContainerFormSubmit : ''}`.trim(), onSubmitCapture: (e) => {
                        ...
                        props.body,
                        props.children))),
                    (showOK || !props.noCancelButton || !!props.footerLeft || !!props.footerRight || !!props.rightButtons || !!props.leftButtons) && (React__default["default"].createElement("div", { className: 'modal-footer' },
        ...
        React__default["default"].createElement(ModalFooter, null,
            ...
            promptResponsesAsArray.map((promptResponse, idx) => {
                ...
                return (React__default["default"].createElement(Button, { key: idx, onClick: () => {
                    ...
                    }, outline: promptResponse.outline, color: (_b = (_a = promptResponse.color) !== null && _a !== void 0 ? _a : props.color) !== null && _b !== void 0 ? _b : 'primary', disabled: promptResponse.disabled, className: 'ms-1' }, promptResponse.label));
            }),
            !!props.okLabel && !!props.okAction && (React__default["default"].createElement(Button, { disabled: props.okDisabled, onClick: okAction, color: (_e = props.color) !== null && _e !== void 0 ? _e : 'primary', className: 'ms-1', 
...
const ReduceInputProps = (props, classNameAdd) => {
    var _a, _b, _c, _d;
    const subset = intelliwaketsfoundation.OmitProperty(props, 'plainText', 'plainTextURL', 'plainTextProps', 'changeValue', 'changeValueLate', 'setChanges', 'setChangesLate', 'autoCompleteOn', 'replaceEmpty', 'append', 'prepend', 'invalid', 'innerRef', 'consoleVerbose');
    if (!!classNameAdd) {
...
const InputWrapper = (props) => {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, props.plainText ? (!!props.plainTextURL ? (React__default["default"].createElement(reactRouterDom.Link, { to: props.plainTextURL },
        React__default["default"].createElement("div", Object.assign({ className: 'form-control-plaintext ' }, props.plainTextProps),
            React__default["default"].createElement(AppendPrependWrapper, { append: props.append, prepend: props.prepend }, (!!props.replaceEmpty && !((_a = props.plainTextControl) !== null && _a !== void 0 ? _a : props.children.props.value)) ? (props.replaceEmpty === true ? React__default["default"].createElement(React__default["default"].Fragment, null, "\u00A0") : props.replaceEmpty) : ((_b = props.plainTextControl) !== null && _b !== void 0 ? _b : props.children.props.value))))) : (React__default["default"].createElement("div", Object.assign({ className: 'form-control-plaintext' + (!!props.plainOnClick ? ' hoverAction cursor-pointer' : '') }, props.plainTextProps, { onClick: () => {
            if (!!props.plainOnClick)
                props.plainOnClick();
        } }),
        React__default["default"].createElement(AppendPrependWrapper, { append: props.append, prepend: props.prepend }, (!!props.replaceEmpty && !((_c = props.plainTextControl) !== null && _c !== void 0 ? _c : props.children.props.value)) ? (props.replaceEmpty === true ? React__default["default"].createElement(React__default["default"].Fragment, null, "\u00A0") : props.replaceEmpty) : ((_d = props.plainTextControl) !== null && _d !== void 0 ? _d : props.children.props.value))))) : (React__default["default"].createElement(InputGroupWrapper, { append: props.append, prepend: props.prepend }, React__default["default"].cloneElement(props.children, ReduceInputProps(Object.assign(Object.assign({}, props.children.props), { className: (((_e = props.children.props.className) !== null && _e !== void 0 ? _e : '') +
            ' ' +
...
function InputNumber(props) {
    ...
    const inputProps = React.useMemo(() => (Object.assign(Object.assign({}, ReduceInputProps(intelliwaketsfoundation.OmitProperty(props, 'decimalScale', 'integerScale', 'allowNegative', 'lowerBound', 'upperBound', 'currency', 'replaceEmpty', 'invalid', 'decimalScaleDisplay', 'name', 'plainTextLeft', 'nullable'))), { value: (!!props.replaceEmpty && (intelliwaketsfoundation.CleanNumber(props.value) === 0)) ? '' : props.value })), [props]);
    ...
    return (React__default["default"].createElement(InputWrapper, Object.assign({}, ReduceToInputAddProps(props), { inputIsValid: (val) => !isNaN(intelliwaketsfoundation.CleanNumber(val, undefined, true)), valueOnInvalid: () => 0, transformToValid: (val) => {
            ...
            (props.replaceEmpty === true ? React__default["default"].createElement(React__default["default"].Fragment, null, "\u00A0") : props.replaceEmpty) :
            (!!props.currency
                    ...
                    return (React__default["default"].createElement(React__default["default"].Fragment, { key: listGroupItem.key },
                        ...
                        listGroupItem.plainText ?
                            React__default["default"].createElement(ListGroupItem, { hidden: listGroupItem.collapsed, onClick: (_c = listGroupItem.linkClick) !== null && _c !== void 0 ? _c : undefined, className: ClassNames({
                                ...
                                React__default["default"].createElement(BadgeItem, { badge: listGroupItem.badge, color: listGroupItem.badgeColor, className: 'float-end small text-white border-round ms-2' }),
                                listGroupItem.counter !== undefined && (React__default["default"].createElement(Badge, { color: listGroupItem.counterColor, className: 'float-end small text-white border-round ms-2' }, listGroupItem.counter !== null ? intelliwaketsfoundation.ToDigits(listGroupItem.counter, 0) :
...
const SelectDD = (props) => {
    ...
    return (React__default["default"].createElement(Dropdown, { size: props.size, className: ((_b = props.className) !== null && _b !== void 0 ? _b : '') + (!!props.likeSelect ? ' input-dd' : '') + (!!props.inline ? ' d-inline-block' : ''), right: props.right, color: (_c = props.color) !== null && _c !== void 0 ? _c : (!!props.inline ? 'primary-outline' : 'primary'), noCaret: !props.caret, buttonClassName: (!!props.classNameBtn ? props.classNameBtn : '') + ' ' + (!!props.inline ? ' btn-link-inline' : ''), buttonFAProps: props.faIcon, buttonLabel: (_d = (selectedItem !== null && selectedItem !== void 0 ? selectedItem : {}).name) !== null && _d !== void 0 ? _d : 'No Selection' }, (props !== null && props !== void 0 ? props : {}).items.map((item) => {
        var _a, _b;
