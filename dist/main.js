...
const TableIDToExcel = (tableID, fileName, appendDateTime = true) => {
    const downloadName = `${fileName !== null && fileName !== void 0 ? fileName : tableID}${appendDateTime ? `-${intelliwaketsfoundation.MomentFormatString(new Date(), 'YYYY-MM-DD_HH-mm-ss')}.xls` : ''}`;
